...
static function array<X2DataTemplate> CreateTemplates()
{
	...
	Sitreps.AddItem(GrantAlienTeamAbilitySitrep(Sitreps, 'ILB_Sitrep_AdventCrackdown_PoisonClouds','ILB_PoisonImmunity', 'ILB_GrantBrutePoisonWeapon'));  //ADVENT Crackdown:  Netzah Cadre
